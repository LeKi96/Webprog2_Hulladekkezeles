...
<body>
  ...
  <nav class="navbar navbar-expand-lg" style="background-color: #e3f2fd;">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
          ...
          <?php if(isset($_SESSION["user_id"])): ?>
            ...
            <?php if($user["Privilages"] == 1): ?>
              <li class="nav-item">
                <a class="nav-link" href="./admin.php">Felhasználók kezelése</a>
              </li>
            <?php endif; ?>
          <?php endif; ?>
        </ul>
      ...
      <!-- Státusz megjelenítése a felhasználói jogosultságok alapján -->
      <div class="navbar-text">
        Státusz: 
        <?php 
          if(isset($_SESSION["user_id"])) {
            if($user["Privilages"] == 0) {
              echo "Regisztrált felhasználó";
            } elseif ($user["Privilages"] == 1) {
              echo "Adminisztrátor";
            }
          } else {
            echo "Látogató";
